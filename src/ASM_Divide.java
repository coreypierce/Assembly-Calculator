...
public class ASM_Divide {
	public static void to_div(int first_number, int second_number) {
		try (PrintWriter fout = new PrintWriter(
			...
			fout.println("not r3,r2");
			fout.println("add r3,r3,#1");
			fout.println("loop add r1,r1,r3");
			fout.println("brn done");
			fout.println("add r4,r4,x1");
			...
			fout.println("msg .stringz " + "\"" + "The Quotient is " + "\"");
			fout.println(".end");
